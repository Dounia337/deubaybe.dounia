                  ...
                  activeFeatured && (
                    <motion.div key={`featured-${slotIndex}`} variants={slot} initial="hidden" animate="show" exit="exit">
                      ...
                      <Link
                        ...
                        className="glass mx-auto mt-4 flex w-full max-w-xl flex-col overflow-hidden text-left transition-all duration-300 hover:-translate-y-1 sm:flex-row sm:items-stretch"
                      >
